...
interface MediaGalleryProps {
  ...
  onAddLink: (title: string, description: string, type: 'audio' | 'video', url: string, passcode: string) => Promise<void>;
...
export default function MediaGallery({
  ...
  const handleLinkSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onAddLink(linkTitle.trim(), linkDesc.trim(), linkType, linkUrl.trim(), passcode);
